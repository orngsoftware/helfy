    ...
    return (
        <div className="container" style={{backgroundColor: "var(--yellow-color)"}}>
            <div className='col' style={{marginTop: 50}}>
                ...
                <Divider text="or" color="var(--dark-yellow-color)" />
                <button onClick={continueWithGoogle} className={"btn-primary green"}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
