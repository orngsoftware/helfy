        ...
        <div className="container" style={{backgroundColor: "var(--yellow-color)"}}>
            <div className='col' style={{marginTop: 50}}>
                ...
                <div className="divider">
                    <div className="hl" style={{backgroundColor: "var(--dark-yellow-color)"}}></div>
                    <p>or</p>
                    <div className="hl" style={{backgroundColor: "var(--dark-yellow-color)"}}></div>
                </div>
                <button className={"btn-primary green"}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
