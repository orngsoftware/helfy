...
const NavBar = () => {
    ...
    return (
        <div className="navbar">
            <div className="row" style={{maxWidth: 300, gap: 50, justifyContent: "center"}}>
                ...
                <motion.div whileTap={{scale: 0.9}} 
                    ...
                    <div className={activeTab === "saved" ? "clickable outline-box tab-active" : "outline-box tab clickable"} 
                        onClick={() => changeTabs("saved")}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill={activeTab === "saved" ? "var(--dark-green-color)" : "var(--black-color)"} viewBox="0 0 256 256"><path d="M184,32H72A16,16,0,0,0,56,48V224a8,8,0,0,0,12.24,6.78L128,193.43l59.77,37.35A8,8,0,0,0,200,224V48A16,16,0,0,0,184,32Z"></path></svg>
                    </div>
                </motion.div>
                <motion.div whileTap={{scale: 0.9}} 
                            animate={{scale: 1}} 
