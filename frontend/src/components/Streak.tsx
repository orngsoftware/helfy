...
export function getStyling(status: string) {
        ...
        return {icon_d: (status === "kept" ? d_lightning : d_cloud), color: (status === "kept" ? "var(--red-color)" : "var(--black-color)"), bgColor: (status === "kept" ? "var(--orange-color)" : "var(--dark-grey-color)")} 
}
